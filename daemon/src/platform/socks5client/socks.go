...
/*
package socks5client implements a SOCKS (SOCKS4, SOCKS4A and SOCKS5) proxy client.
...
*/
package socks5client // import "h12.io/socks"
...
func DialCtx(proxyURI string) func(ctx context.Context, addr string, ip string) (net.Conn, error) {
	dial := Dial(proxyURI)
	return func(ctx context.Context, add string, ip string) (net.Conn, error) {
		return dial(add, ip)
	}
}
